...
Public Class Cetak_penambahan
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "RevisiIMB.Cetak_penambahan.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCetak_penambahan
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As Cetak_penambahan = New Cetak_penambahan()
        rpt.Site = Me.Site
        Return rpt
    End Function
