...
Public Class Cetak_ruko_imb
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "RevisiIMB.Cetak_ruko_imb.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCetak_ruko_imb
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As Cetak_ruko_imb = New Cetak_ruko_imb()
        rpt.Site = Me.Site
        Return rpt
    End Function
